<template>
    <div>
        ...
        <div class="bbox" :class="{bbox_active:disActive}">
            <div class="pan" :style="{backgroundImage:'url('+pan+')'}" :class="{pan_active:disActive}" @click="DisActive" title="收起">
            ...
            <div class="box" :style="{backgroundImage:'url('+musicImg+')'}" :class="{box_active:disActive}" @dblclick="DisList">
                ...
                <div class="music_dis">
                    <div class="dis_list" @click="DisList" title="打开完整页面">···</div>
                    <p class="music_title">{{musicTitle}}</p>
                    <p class="music_intro">歌手: {{musicName}}</p>
                    <!-- 歌词 -->
                    <ul class="music_words">
            ...
            <video id="music" :autoplay="true" :src="musicUrl" name="media">
            </video>
        </div>
    </div>
